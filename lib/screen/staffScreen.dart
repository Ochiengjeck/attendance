...
// Import screens and assets as needed
...
class _StaffScreenState extends State<StaffScreen> {
  ...
  void initState() {
    ...
    // Initialize screens
    screens = [
      StaffScreenContent(admins: admins),
      Courses(),
      Messages(),
      Notice(),
    ];
  ...
  Future<void> _loadData() async {
    try {
      ...
      // Set state to rebuild the UI with fetched data
      setState(() {});
    } catch (e) {
      // Handle errors if any
      print('Failed to load data: $e');
      // Handle error UI or retry mechanism if needed
    }
  }
...
class StaffScreenContent extends StatelessWidget {
  ...
  StaffScreenContent({Key? key, required this.admins}) : super(key: key);
  ...
  getStudentCount(String courseName) {
    switch (courseName) {
      case 'IoT':
        return IoT.length;
      case 'HCI':
